...
public class DownloaderTest extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!DownloaderActivity.ensureDownloaded(this,
				getString(R.string.app_name), FILE_CONFIG_URL, CONFIG_VERSION,
	 ...
	 */
	private final static String FILE_CONFIG_URL = "http://192.168.10.218/download.config";
	private final static String CONFIG_VERSION = "2.0";
