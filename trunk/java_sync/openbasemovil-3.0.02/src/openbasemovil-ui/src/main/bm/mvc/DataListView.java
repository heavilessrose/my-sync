        ...
        implements ListBrowser
{
     ...
     */
    public void addSpeedOption( final int code, final String text, final String help )
    {
     ...
     * @param help help text
     */
    public void addSpeedOption( final int code, final Image image, final String help )
    {
