 ...
 * @version $Revision$
 */
public class IndexResourceProvider implements ResourceProvider {
	...
	public IndexResourceProvider(final String indexName, final int indexOrder,
	 ...
	 * 
	 * @param bundleNames
	 *            array with names of the resource bundles
	 * @param langs
	 *            array with languages to use for the index
	 * @throws IOException
	 *             if a bundle can't be found or an error reading a bundle
	 * @throws RecordStoreFullException
	 *             if no space left
	 * @throws RSException
	 *             on errors at the storage system
	 * @throws DBException
	 *             on errors building the index
	 */
	public void buildIndex(final String[] bundleNames, final String[] langs)
			throws IOException, RecordStoreFullException, RSException,
			DBException {
