...
//        }
    ...
    /**
     * If the displayable is a form, the focusedItem is selected on a call to show.
     */
    ...
    /**
     * Get the displayable object of this view. This method is intended
     * for those clases that use an AbstractView directly as a Delgate to
     * achieve inheritance.
     *
     * @return displayable
     */
    ...
    /**
     * Set the displayable object of this view. This method is intended
     * for those clases that use an AbstractView directly as a Delgate to
     * achieve inheritance.
     ...
     * @param item item
     * @param command command
     * @param defaultCommand if command should be the item default command
     */
     ...
     * @param resource resource identifier for label, if resource not found, the text is used as label
     * @param command command
     * @return a StringItem button
     */
    protected StringItem createButton(
    ...
    {
        if(
                actions.containsKey( action.getName() ) &&
    ...
    /**
     * Attach an obeject to the view. Useful for state management.
    ...
    {
        final Object value = attachments.get( key );
        return value != null && value instanceof FixedPoint ?
                (FixedPoint) value :
                null;
    }
