    ...
    extends OutputStream
{
    ...
    {
        this.out = out instanceof DataOutputStream ?
    ...
    public void writeInt( final Integer i )
            throws SerializationException
    {
        try
        {
            ...
            throws SerializationException
    {
        try
        {
            out.writeUTF( s.length() > maxLength ?
    ...
    public void writeBlob( final byte[] data )
            throws SerializationException
    {
        ...
        try
        {
            ...
            else if( o instanceof Serializable )
            {
                ...
                final String className =
                        ((Serializable) o).getSerializableClassName();
                if( className != null )
                {
