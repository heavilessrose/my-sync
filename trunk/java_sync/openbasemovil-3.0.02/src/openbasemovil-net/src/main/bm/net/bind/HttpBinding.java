    ...
    extends Binding
{
            ...
            throws NetException
    {
        try
        {
            ...
            String target = url;
            if(
                    Net.getEncryptionLevel() == Net.NET_ENCRYPTION_LEVEL_HIGH &&
                    url.startsWith( "http:" )
            )
            {
    ...
    public void close()
    {
        ...
        if( connection != null ) try{ connection.close(); } catch( Exception e ){} finally{ connection = null; }
    }
     ...
     * @throws NetException on errors
     */
    public DataOutputStream beginPost()
            throws NetException
    {
        try
        {
     ...
     * @throws NetException on errors
     */
    public DataInputStream endPost()
            throws NetException
    {
        try
        {
