...
/**
 * A Binding represents a plugable interface to an HttpConnection, so it
 * can be performed directly or through other means, such as a Bluetooth
 * connection.
 *
...
public abstract class Binding
{
     ...
     *
     * This is not a good way to get the class, but CLDC 1.0 will fail
     * if we use HttpBinding.class, and if we use Class.forName() the
     * link will be weak for the obfuscator and we'll had to deal with the
     * exceptions.
     */
     ...
     */
    public abstract void open( final String url )
        throws NetException;
    ...
    /**
     * Begin the post operation, open the output stream to send content to
     * the server.
     * @return OutputStream to send content.
     * @throws NetException on errors
     */
    public abstract DataOutputStream beginPost()
        throws NetException;
     ...
     * @throws NetException on errors
     */
    public abstract DataInputStream endPost()
            throws NetException;
     ...
     * @param url url
     * @return page text
     * @throws bm.net.NetException on errors
     */
