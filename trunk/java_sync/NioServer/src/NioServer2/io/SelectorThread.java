 ...
 * internally by EventQueue. The SelectorThread class performs a similar task.
 * In particular:
 * 
...
final public class SelectorThread implements Runnable {
	 ...
	 * exception is thrown. Use the addChannelInterestLater() when calling from
	 * another thread.
	 * 
	 * @param channel
	 *            The channel to be updated. Must be registered.
	 * @param interest
	 *            The interest to add. Should be one of the constants defined on
	 *            SelectionKey.
	 */
	...
	/**
	 * Like addChannelInterestNow(), but executed asynchronouly on the selector
	 ...
	 *            The channel to be updated. Must be registered.
	 * @param interest
	 *            The new interest to add. Should be one of the constants
	 *            defined on SelectionKey.
	 * @param errorHandler
	 *            Callback used if an exception is raised when executing the
	 *            task.
	 */
	 ...
	 *            The channel to be updated. Must be registered.
	 * @param interest
	 *            The interest to be removed. Should be one of the constants
	 *            defined on SelectionKey.
	 */
	 ...
	 *            The channel to be updated. Must be registered.
	 * @param interest
	 *            The interest to remove. Should be one of the constants defined
	 *            on SelectionKey.
	 * @param errorHandler
	 *            Callback used if an exception is raised when executing the
	 *            task.
	 ...
	 * @param selectionKeys
	 *            The interest set. Should be a combination of SelectionKey
	 *            constants.
	 * @param handler
	 *            The handler for events raised on the registered channel.
	 * @param errorHandler
	 *            Used for asynchronous error handling.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Executes the given task synchronously in the selector thread. This method
	 * schedules the task, waits for its execution and only then returns.
	 * 
	 * @param run
	 *            The task to be executed on the selector's thread.
	 */
