...
{
    public static final Logger instance = new Logger(15,"y!p!","astrient:1e4e4d:-1985900");
    
    private static int sequenceNumberMajor = Calendar.getInstance().get(Calendar.DAY_OF_MONTH);
    ...
    public void log(String message)
    {
        ...
        if ( logListener != null ) logListener.log(message);
    ...
    {       
        ...
        if ( count > 0 )
        {
            ...
            if ( url == null ) 
                url = "http://www.hostj2me.com/"; //url = "http://127.0.0.1/j2me/";
            url += "applog";
            ...
            {   
                ...
                for (int i = 0; i < count; i++ )
                {
                    ...
                    dos.writeUTF("SEQN: " + sequenceNumberMajor + "." + (sequenceNumberMinor++));
