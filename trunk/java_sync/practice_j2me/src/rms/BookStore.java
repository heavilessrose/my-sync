...
public class BookStore implements RecordComparator, RecordFilter {
	...
	public void saveBookInfo(BookInfo bookInfo) throws IOException,
	...
	public int compare(byte[] book1, byte[] book2) {
		try {
			DataInputStream stream1 = new DataInputStream(
					new ByteArrayInputStream(book1));
			DataInputStream stream2 = new DataInputStream(
					new ByteArrayInputStream(book2));
