 ...
 * <code>StringUtil</code> methods do not distinguish among
 ...
 * <p>
 * An instance of <code>StringUtil</code> behaves in one of two
 ...
 *     not delimiters.
 * </ul><p>
 * A <tt>StringUtil</tt> object internally maintains a current
 * position within the string to be tokenized. Some operations advance this
 * current position past the characters processed.<p>
 * A token is returned by taking a substring of the string that was used to
 * create the <tt>StringUtil</tt> object.
 * <p>
 * The following is one example of the use of the tokenizer. The code:
 * <blockquote><pre>
 *     StringUtil st = new StringUtil("this is a test");
 ...
 *
 * <p>
 * <tt>StringUtil</tt> is a legacy class that is retained for
 ...
 */
public
        class StringUtil implements Enumeration {
     ...
     * resulting <tt>StringUtil</tt> may result in a
     ...
     *                         as tokens.
     */
    public StringUtil(String str, String delim, boolean returnDelims) {
        currentPosition = 0;
        newPosition = -1;
        delimsChanged = false;
        this.str = str;
     ...
     * @param   delim   the delimiters.
     */
    public StringUtil(String str, String delim) {
     ...
     * <tt>StringUtil</tt> object is changed to be the characters in
     ...
     * @see     java.util.StringUtil#hasMoreTokens()
     */
     ...
     *               tokenizer's string.
     * @see        java.util.Enumeration
     * @see        java.util.StringUtil#nextToken()
     */
    ...
    public static long getData(String s){
        ...
        StringUtil sd = new StringUtil(date,"-");
        int i = 0;
        ...
        i=0;
        StringUtil st = new StringUtil(time,":");
        while(st.hasMoreTokens()){
