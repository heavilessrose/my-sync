 ...
 */
public class NumbericUpDown extends BaseControl {
    ...
    public NumbericUpDown() {
        ...
        NumEdit.setTextAlign(ConstsUI.alignCenter);
        NumEdit.setBorderStyle(ConstsUI.bsNone);
        AddControl(NumEdit);
        ...
        NumEdit.setOnFocused(new NotifyEvent() {
            ...
            public void Event(BaseControl ctrl) {
                form.Application.inputPanel.ImeType = InputPanel.imDigit;
    ...
    private void setTextEditPos() {
        ...
        NumEdit.setImeType(InputPanel.imDigit);
    }
    ...
    private void doKeyUp(int keyCode) {
        ...
        if ((key.equals(ConstsUI.KEY_LEFT)) || (key.equals(ConstsUI.KEY_UP))) {
            //左
            if (value > minValue) {
                value -= increment;
            }
        }
        if ((key.equals(ConstsUI.KEY_RIGHT)) || (key.equals(ConstsUI.KEY_DOWN))) {
            //右
            if (value < maxValue) {
                value += increment;
            }
