 ...
 * @version 1.0
 */
public class Bevel extends BaseControl {
	// Shape
	...
	private void DrawShadowRect(Graphics g) {
		...
		int lColor = (this.style == styleLowered ? ConstsUI.clBtnShadow
				: ConstsUI.clWhite);
		int rColor = (this.style == styleLowered ? ConstsUI.clWhite
				: ConstsUI.clBtnShadow);
