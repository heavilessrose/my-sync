 ...
 */
public class SDADateTimePicker extends SDABaseControl {
    ...
    //格式
    private int dateKind = SDAConsts.dkDate;
    ...
    public SDADateTimePicker() {
        ...
        NumEdit.setBorderStyle(SDAConsts.bsFixedSingle);
        NumEdit.backColor = SDAConsts.clFocusShadow;
        NumEdit.foreColor = SDAConsts.clWhite;
        ...
        NumEdit.setOnTextChange(new BaseEditTextChangeEvent() {
            ...
            public void Event(SDABaseEdit edit) {
                //文字变化
                int value = 0;
                try {
    ...
    private void setDateTime() {
        ...
        Minute = cl.get(Calendar.MINUTE);
        Second = cl.get(Calendar.SECOND);
        if (dateKind == SDAConsts.dkDate) {
            dateTime = String.valueOf(Year) + "-" + String.valueOf(Month) + "-" + String.valueOf(Day);
        }
        if (dateKind == SDAConsts.dkTime) {
            dateTime = String.valueOf(Hour) + ":" + String.valueOf(Minute) + ":" + String.valueOf(Second);
        }
        if (dateKind == SDAConsts.dkDateTime) {
            dateTime = String.valueOf(Year) + "-" + String.valueOf(Month) + "-" + String.valueOf(Day) + " " +
    ...
    private void setSelectTypePos(int selectType) {
        ...
        if (dateKind == SDAConsts.dkDate || dateKind == SDAConsts.dkDateTime) {
            switch (selectType) {
                case 0:
                    result = 0;
                    selectLen = yearLen;
    ...
    protected boolean canDownTabNext() {
        ...
        if (dateKind == SDAConsts.dkDateTime || dateKind == SDAConsts.dkTime) {
            if (selectType == 5) {
                result = true;
            } else {
                result = false;
