...
//	if ([[FontManager sharedManager] loadSystemFont:@"STHeiti-Medium"] == NO) {
//		test = @"失败";
//	}
	if ([[FontManager sharedManager] loadSystemFont:@"Zapfino"] == NO) {
		test = @"失败";
	}
	if ([[FontManager sharedManager] loadSystemFont:@"arialuni"] == NO) {
		test = @"失败";
	}
	if ([[FontManager sharedManager] loadSystemFont:@"华文楷体"] == NO) {
		test = @"失败";
	}
