...
TypeListController
View controller for changing the type of a specific item. Displays a list of types with a checkmark accessory view indicating the designated row. Selection of a row changes the type and navigates back to the previous view.
