...
#import "LKSegmenteControl.h"

@implementation LKSegmenteControl
@synthesize buttons;
...
- (void)touchDownAction:(UIButton*)button
{
    ...
    if (delegate && [delegate respondsToSelector:@selector(touchDownAtSegmentIndex:)]) {
...
- (void)touchUpInsideAction:(UIButton*)button
{
    ...
    if (delegate && [delegate respondsToSelector:@selector(touchUpInsideSegmentIndex:)]) {
