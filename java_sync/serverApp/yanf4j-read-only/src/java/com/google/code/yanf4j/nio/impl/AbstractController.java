...
public abstract class AbstractController extends SessionFlowController {
	...
	protected List<ControllerStateListener> stateListeners = new LinkedList<ControllerStateListener>();
	...
	// session集合
	private Set<Session> sessionSet = new ConcurrentHashSet<Session>();
	...
	@SuppressWarnings("unchecked")
	private void init(Configuration configuration, Handler handler,
			CodecFactory codecFactory) {
	...
	public void open(InetSocketAddress inetSocketAddress, Handler handler)
			throws IOException {
		open(inetSocketAddress, true, handler);
	}

	@SuppressWarnings("unchecked")
	public void open(InetSocketAddress inetSocketAddress, Handler handler,
			CodecFactory codecFactory) throws IOException {
		open(inetSocketAddress, true, handler, codecFactory);
	}
