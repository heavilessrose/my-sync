 ...
 * applications. Simply derived this class to start your own Kuix application.
 * 
 * @author bbeaulant
 */
public abstract class KuixMIDlet extends MIDlet implements KuixInitializer,
		WorkerErrorListener, CommandListener {
	 ...
	 * 
	 * @see
	 * org.kalmeo.kuix.core.KuixInitializer#getInitializationBackgroundColor()
	 */
	 ...
	 * 
	 * @see
	 * org.kalmeo.kuix.core.KuixInitializer#initDesktopContent(org.kalmeo.kuix
	 * .widget.Desktop)
	 */
	...
	private static final Command FATAL_EXIT_COMMAND = new Command("Exit",
			Command.EXIT, 0);

	/**
	 * Display a basic lcdui fatal error alert popup with the given
	 * <code>message</code>. After displaying the message the application will
	 * be closed.
	 * 
	 * @param message
	 * @since 1.0.1
	...
	/**
	 * Display a basic lcdui fatal error alert popup with the given
	 * <code>message</code> and <code>throwable</code>. After displaying the
	...
	protected void startApp() throws MIDletStateChangeException {
		...
		if (!Kuix.isInitialized()) {
			...
			if (frameDurationValue != null) {
				int frameDuration = Integer.valueOf(frameDurationValue)
						.intValue();
	 ...
	 * 
	 * @see
	 * org.kalmeo.util.worker.WorkerErrorTracker#onWorkerError(java.lang.Error)
	 */
	 ...
	 * 
	 * @see
	 * org.kalmeo.util.worker.WorkerErrorTracker#onException(java.lang.Exception
	 * )
	 */
