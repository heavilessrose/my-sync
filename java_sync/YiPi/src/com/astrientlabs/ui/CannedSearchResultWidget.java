...
{      
    ...
    public CannedSearchResultWidget(Window parent, Image image, String name, Object value)
    {
        super(parent);
    ...
    public void paint(Graphics g, int x, int y, int maxX, int maxY, boolean hasFocus)
	{
        ...
        g.drawString(Strings.getText(name,maxTextLen,"..."),x+padding+thumbnailWidth+padding+1,y+padding+borderSize,Graphics.TOP|Graphics.LEFT);
        g.drawString(Strings.getText(value.toString(),maxTextLen,"..."),x+padding+thumbnailWidth+padding+1,y+borderSize+padding+g.getFont().getHeight()+padding,Graphics.TOP|Graphics.LEFT);
    }
