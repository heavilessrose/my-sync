...
public class PopupWidget extends ListWidget {
	...
	public PopupWidget(Window parent, int widgetWidth, int widgetHeight,
			int bgColor) {
	...
	public void setText(String text) {
		clear();
		LineEnumeration le = new LineEnumeration(Fonts.TEXT, text, widgetWidth
				- padding - scrollbarWidth - padding);
		LabelWidget widget;
