...
public final class Util
{
     ...
     * @throws RecordStoreException on storage errors
     */
            ...
            throws RecordStoreException
    {
        ...
        buffer.append( ResourceManager.getResource( "util.usedStorage" ) )
                ...
                .append( size )
                .append( "\n" )
                .append( ResourceManager.getResource( "util.freeStorage" ) )
                .append( ": " )
    ...
    public static String URLEncode( String s )
    {
        ...
        for( int i = 0; i < length; i++ )
        {
            ...
            {
                encoded.append( '%' )
                        .append( Integer.toHexString(0xc0 | ( chars[i] >> 6 )) )
                        .append( '%' )
                        .append( Integer.toHexString(0x80 | ( chars[i] & 0x3F )) );
            }
            else
            {
                encoded.append( '%' )
                        .append( Integer.toHexString(0xe0 | ( chars[i] >> 12 )) )
                        .append( '%' )
                        .append( Integer.toHexString(0x80 | ( ( chars[i] >> 6 ) & 0x3F )) )
                        .append( '%' )
                        .append( Integer.toHexString(0x80 | ( chars[i] & 0x3F )) );
            }
        }
     ...
     *
     * @param name name of index store
