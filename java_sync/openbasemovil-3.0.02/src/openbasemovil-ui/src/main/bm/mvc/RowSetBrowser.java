...
//    private static Log log = LogFactory.getLog( "RowSetBrowser" );
    ...
    public RowSetBrowser( final String title )
    {
        super( title );
        cmd = new Command(
                ResourceManager.getResource( "rowSetBrowser.select" ),
                Command.OK,
                -1
        );
    }
...
//            }
    ...
    public void setRowSet (final RowSet rowset)
            throws
...
//            );
    ...
    {
        final int width = (totalWidth * (rowset.getPosition()+1)) / rowset.size();
        // Color principal
