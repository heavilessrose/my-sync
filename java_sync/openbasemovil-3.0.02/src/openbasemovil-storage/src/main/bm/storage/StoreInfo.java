...
public class StoreInfo implements Serializable {
	...
	static synchronized void flush() throws RSException {
		RSException e = null;
	...
	public static synchronized void set(final StoreInfo info)
			throws SerializationException, RSException {
	...
	public void addRecord(final int length) throws SerializationException {
		count++;
		size += length;
		nextId++;
	...
	public void deleteRecord(final int length) throws SerializationException {
		count--;
		lastModified = System.currentTimeMillis();
		size -= length;
		dirty = true;
