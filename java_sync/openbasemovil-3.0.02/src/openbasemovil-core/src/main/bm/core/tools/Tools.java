...
public final class Tools
{
     ...
     * @throws bm.core.J2MEException if cant allocate memory
     */
    public static byte[] secureAlloc( final int size )
            throws J2MEException
    {
        ...
        {
            log.warn( "Could not allocate " + size + " bytes, free mem: " + Runtime.getRuntime().freeMemory() );
            System.gc();
            try
            {
                return new byte[ size ];
     ...
     * @return true if both are null or are of the same class and
     * o1.equals( o2 ) returns true, false otherwise
     */
     ...
     *
     * @param str string
     * @param preserveSeparators preserve separator characters as words
     * @return a list of words
     */
     ...
     *
     * @param str string
     * @param separators a string with all the characters to use as word boundaries
     * @param preserveSeparators preserve separator characters as words
     * @return a list of words
     */
    public static Vector getWords(
     ...
     * given width in pixels and fonts for making calculations. Two fonts can
     * be given, one for the first line and other for the rest.<br/>
     ...
     * @param font1 font for the first line
     * @param font2 font for the second line
     * @param width witdh of region to use in pixels
     * @param lines maximum number to split the text into
     * @param wrap if wrapping should happen when a line is too long
