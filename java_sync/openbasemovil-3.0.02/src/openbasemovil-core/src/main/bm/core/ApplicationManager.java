...
/**
 * The Application Manager handles calls that are used through out the
 * application but wich implementation is dependent on the underlying system.<br/>
...
public interface ApplicationManager {
	 ...
	 * @return index of the option selected
	 */
	int select(String title, String[] options, String ticker);
	 ...
	 *            maximum size for text
	 * @param constraints
	 *            as specified in MIDP TextField
	 * @return value entered by the user, null if the user cancelled edition
	 */
	 ...
	 *            key
	 * @param defaultValue
	 *            default value if not found or invalid number
	 * @return value or defaultValue
	 */
