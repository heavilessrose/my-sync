...
public class SerializerInputStream extends InputStream {
	...
	public Integer readNullableInt() throws SerializationException {
		try {
	...
	public Byte readNullableByte() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
	...
	public Boolean readNullableBoolean() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
	...
	public Short readNullableShort() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
	...
	public Long readNullableLong() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
	...
	public Date readDate() throws SerializationException {
		try {
	...
	public Date readNullableDate() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
				return new Date(in.readLong());
	...
	public String readNullableString() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
				return in.readUTF();
	...
	public byte[] readBlob() throws SerializationException {
		try {
	...
	public byte[] readNullableBlob() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
				return readBlob();
	...
	protected Object parseObject(final byte type)
		...
		case CoreConstants.SERIALIZABLE:
			try {
				...
				final Serializable serializable = (Serializable) clazz
						.newInstance();
				serializable.deserialize(this);
				return serializable;
			} catch (Exception e) {
				throw new SerializationException(
						CoreConstants.ERR_TOL_INVALID_SERIALIZABLE_OBJECT, e);
			}
	...
	public Object readNullableObject() throws SerializationException {
		try {
			final boolean isNull = in.readBoolean();
			if (!isNull) {
				return readObject();
