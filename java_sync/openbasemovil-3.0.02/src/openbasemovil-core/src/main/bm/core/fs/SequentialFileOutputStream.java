 ...
 * @version $Revision: 6 $
 */
public class SequentialFileOutputStream extends OutputStream {
	...
	public SequentialFileOutputStream(final String name, final int clusterSize) {
		this.name = name;
	...
	public void open() throws RecordStoreFullException, FSException {
		if (rs == null) {
			try {
	...
	private void writeHeader() throws IOException, RecordStoreFullException,
