 ...
 * File Information
 *
 * Created on       : 29-mar-2007 16:24:15
 * Created by       : narciso
...
public class SerializerOutputStream extends OutputStream {
	...
	public SerializerOutputStream(final OutputStream out) {
		this.out = out instanceof DataOutputStream ? (DataOutputStream) out
	...
	public void writeNullableDate(final Date date)
	...
	public void writeString(final String s, final int maxLength)
			throws SerializationException {
		try {
			out
					.writeUTF(s.length() > maxLength ? s
							.substring(0, maxLength) : s);
		} catch (IOException e) {
			throw new SerializationException(CoreConstants.ERR_SOS);
		}
	}

	public void writeNullableString(final String s, final int maxLength)
			throws SerializationException {
		try {
			out.writeBoolean(s == null);
			if (s != null) {
				out.writeUTF(s.length() > maxLength ? s.substring(0, maxLength)
						: s);
			}
		} catch (IOException e) {
			throw new SerializationException(CoreConstants.ERR_SOS);
	...
	public void writeNullableString(final String s)
			throws SerializationException {
		try {
			out.writeBoolean(s == null);
			if (s != null) {
	...
	public void writeBlob(final byte[] data, final int offset, final int length)
			throws SerializationException {
		try {
	...
	public void writeNullableBlob(final byte[] data)
			throws SerializationException {
		try {
	 ...
	 * Objects can be of one of these types: Serializable, String, Long, Byte,
	 * Date, Boolean, Integer, Short, byte[].<br/>
	 * They can also be collections of objects of the above types, to any
	 * nesting level. Collections can be simple arrays, Vector or Hashtable.
	 * 
	 * @param o
	 *            value to write
	 * @throws bm.core.io.SerializationException
	 *             on serialization exceptions
	 */
	public void writeObject(final Object o) throws SerializationException {
		try {
			if (o instanceof byte[]) {
				...
				final String className = ((Serializable) o)
	...
	public void writeNullableObject(final Object o)
			throws SerializationException {
		try {
