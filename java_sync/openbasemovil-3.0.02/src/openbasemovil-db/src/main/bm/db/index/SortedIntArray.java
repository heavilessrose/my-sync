        ...
        implements Serializable
{
     ...
     * @param growthFactor entries allocated when more space is needed
     */
    ...
    /**
     * Insert a new value into the array.<br/> If the value is already on the
     * array nothing is done, and it's index is returned.
     *
     * @param value value to insert.
     * @return if the array has fixed length and no more space is available this
     * method returns -1 indicating that the value could not be inserted, otherwise
     * the index at which the value was inserted is returned.
     */
    ...
    /**
     * Read the contents of the array from an input stream.<br/>This method will
     * enlarge the currently allocated buffer if it's not enough to hold the
     * values from the stream, but won't change the growth factor, so the array
     * will remain fixed or variable size, whatever it was before calling this
     * method.<br/>What this means is that the growth factor is not persisted.
     *
