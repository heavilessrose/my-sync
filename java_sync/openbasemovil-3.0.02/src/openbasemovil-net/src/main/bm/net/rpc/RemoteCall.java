 ...
 * A call is made upon a remote object name, to a given method, and supports
 * a number of parameters with some limitations.<br/>
 * Parameters can be of one of these types:
 * Serializable, String, Long, Byte, Boolean, Integer, Short.<br/>
    ...
    implements Serializable
{
     ...
     * @param encrypted perform encryption
     */
    public RemoteCall(
            final String    object,
            final String    method,
    ...
    public Object invoke( final String url )
            throws RemoteCallException,
                   NetException
    {
        log.debug( "invoke: " + object + "." + method + "(" + Tools.arrayAsVector( parameters ) + ")" );
        Object retval = null;
        int retries = 0;
        Exception lastException = null;
        boolean done = false;
        while( !done && retries < Net.MAX_RETRIES && !ControlledTask.isCancelled() )
        {
            try
            {
                lastException = null;
    ...
    Remote Procedure Call protocol:
        ...
        (data:
            ...
            {byte[]     parameters}     // Parameters serialized using core Tools.writeNullableObject
        )
        {String     "END_OF_DATA"}      // Constant text to identify data boundary
        ...
        Server response:
            ...
            {byte[]     responseData}       // An object serialized using Tools.writeNullableObject
                                            // In version 1 the object was serialized with Tools.writeObject
                                            // and null was not a valid return value
    ...
    */
    private Object doInvoke( final String url )
            throws NetException,
