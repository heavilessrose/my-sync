...
final public class Connector implements ConnectorSelectorHandler {
	 ...
	 * 
	 * @param remoteAddress
	 *            The remote endpoint where to connect.
	 * @param listener
	 *            The object that will receive the callbacks from this
	 *            Connector.
	 * @param selector
	 *            The selector to be used.
	 * @throws IOException
	 */
	public Connector(SelectorThread selector, InetSocketAddress remoteAddress,
