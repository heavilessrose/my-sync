...
final public class PacketChannel implements ReadWriteSelectorHandler {
	 ...
	 * @throws IOException
	 */
	public PacketChannel(SocketChannel socketChannel, SelectorThread selector,
			ProtocolDecoder protocolDecoder, PacketChannelListener listener)
			throws IOException {
		...
		inBuffer = ByteBuffer
				.allocateDirect(sc.socket().getReceiveBufferSize());
