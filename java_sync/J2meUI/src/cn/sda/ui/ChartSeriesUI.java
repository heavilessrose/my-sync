...
public class ChartSeriesUI {
	...
	private int marksBackColor = ConstsUI.clBtnFace;
	private int lineColor = ConstsUI.clBlack;
	...
	protected void setChart(ChartUI chart) {
		this.chart = chart;
	}
