 ...
 * @version 1.0
 */
public class RadioButtonUI extends BaseControl {
	...
	private void InitRadioButton(String text) {
		this.backColor = ConstsUI.clWhite;
	...
	public RadioButtonUI(String text) {
	...
	public void Click() {
		...
		if (!this.checked) {
			for (int i = 0; i < radios.size(); i++) {
				RadioButtonUI radio = ((RadioButtonUI) radios.elementAt(i));
