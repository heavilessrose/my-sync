...
enum screen_id
{
    ...
    WINKS_UI_DISABLE_ID,
    //WINKS_UI_CCSHOW_ID,
    WINKS_UI_TRAFFICSTAT_ID,
#ifdef WINKS_EMBEDDED_BROWSER
	WINKS_UI_EBROWSER_ID,
	WINKS_UI_TOURONLINE_ID,
...
// Loading Screen
int Winks_UI_Enter_Disable(int Opcode);
int Winks_UI_Exit_Disable(Winks_Widget_ScnLayer_s** ppScnLayer, int Option, unsigned long wParam, unsigned long lParam);

//TrafficStatistics Screen
int Winks_UI_Enter_TrafficStat(int Opcode);
int Winks_UI_Exit_TrafficStat(Winks_Widget_ScnLayer_s** ppScnLayer, int Option, unsigned long wParam, unsigned long lParam);

#ifdef WINKS_EMBEDDED_BROWSER
// EBrowser Screen
int Winks_UI_Enter_EBrowser(int Opcode);
int Winks_UI_Exit_EBrowser(Winks_Widget_ScnLayer_s** ppScnLayer, int Option, unsigned long wParam, unsigned long lParam);

// Tour Online Screen
int Winks_UI_Enter_TourOnline(int Opcode);
int Winks_UI_Exit_TourOnline(Winks_Widget_ScnLayer_s** ppScnLayer, int Option, unsigned long wParam, unsigned long lParam);
#endif //#ifdef WINKS_EMBEDDED_BROWSER
