...
#define WINKS_SIMULATOR
    ...
    #define WINKS_SUPPORT_3G                                        /*3G:来电联网功能。*/
    #define WINKS_SENDSMS_UPGRADE
    #define WINKS_MTK
...
//    #define WINKS_SUPPORTED_PB_INFO     (0x00004000UL)              /*支持名片的控制项*/
    ...
    #define WINKS_APP_PATH                WINKS_ROOT_PATH"winks\\"
#ifdef __240X320__
    #define WINKS_IMG_PATH                WINKS_ROOT_PATH"winks\\image\\240x320\\"
#endif
#ifdef __320X240__
    #define WINKS_IMG_PATH                WINKS_ROOT_PATH"winks\\image\\320x240\\"
#endif
...
char* Winks_getversion(int flag);
    ...
    #define WINKS_AV                    Winks_getversion(1)     //"1.1.2000" //    /*version 终端软件包版本 */
...
char *Symbian_GetPhoneType();
    ...
    #define WINKS_MT                    "gif,png,jpeg"              /*mediaTypes 媒体格式列表*/
char *Symbian_GetADC();
    #define WINKS_ADC                   Symbian_GetADC()      //"1" //                  /*dist-channel 安装渠道编码,可用函数获取*/
//    #define WINKS_BUA                   "WAPUSERAGENT"              /*base64-user-agent:client default browser user-agent string*/
...
#undef WINKS_SIMULATOR
	...
	#define WINKS_SCREEN_WIDTH          320                         /*屏宽，分辨率*/
	#define WINKS_SCREEN_HEIGHT         240                         /*屏高，分辨率*/
    ...
    #define WINKS_AN                    "winks-WMSP"                /*package-name 终端软件包名称 */
...
char *WM_GetPhoneType();
    #define WINKS_HW                    WM_GetPhoneType()                   /*hardware-id 终端硬件标识 */
    #define WINKS_CL                    "240x236"                   /*canvasList 彩像媒体展示尺寸列表*/
    #define WINKS_MT                    "gif,png,jpeg"              /*mediaTypes 媒体格式列表*/
...
//    #define WINKS_BUA                   "WAPUSERAGENT"              /*base64-user-agent:client default browser user-agent string*/
	...
	#define WINKS_START_SHOWCC_ASYNC
	#define WINKS_DUAL_SIM
	#define WINKS_SENDSMS_UPGRADE  //发短信改成异步
#else
    //#define WINKS_MULTITHREADING                                  /*多线程*/
    #define WINKS_SUPPORT_3G                                        /*3G:来电联网功能。*/
    #define WINKS_UNSUPPORTED_GLOBAL_VAR
...
/*APN的设置*/
    ...
    #define WINKS_PROXY_SERVER_IP "0.0.0.0"
    #define WINKS_PROXY_SERVER_PORT 0
    #define WINKS_DEFAULT_ACCESS_POINT 0//1131344196
//#else
...
/* 推荐最大个数*/
#define WINKS_RECOMMAND_MAX_NUM 5       /*推荐最大个数*/
