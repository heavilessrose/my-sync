 ...
 * 封装了http联网操作.
 * 
 * A wrapper for the HttpConnection interface that logs method calls and state
 * transitions. Wrap a connection immediately after obtaining it from
 * Connector.open. Information is logged according to the log level set the
 * "httpwrapper" logger.
 */
public class HttpConnectionWrapper implements HttpConnection {
	 ...
	 * 
	 * @param method
	 *            the method that is the root of the exception.
	 * @param msg
	 ...
	 * 
	 * @param method
	 *            the method invoked when the exception occurred.
	 * @param e
	 *            the exception.
	 * 
	 * @throws IOException
	...
	/**
	 * Ensures that a method is not invoked in closed state, but swallows the
	 * resulting exception if any.
	 * 
	 * @param method
	 *            the method invoked.
	 */
	...
	/**
	 * Transitions from setup state to connected state.
	 * 
	 * @param method
	 *            the method invoked.
	 * 
	...
	/**
	 * Transitions from setup state to connected state, but swallows the
	 * resulting exception if any.
	 * 
	 * @param method
	 *            the method invoked.
