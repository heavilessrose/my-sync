 ...
 * @author Robert Virkus <j2mepolish@enough.de> (architectural changes)
 */
public class KeysInfoCollector extends InfoCollector implements DynamicTestView {
	...
	public void collectInfos(MIDPSysInfoMIDlet midlet, Display disp) {
		...
		addInfo("Canvas.LEFT: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.LEFT)));
		addInfo("Canvas.RIGHT: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.RIGHT)));
		addInfo("Canvas.DOWN: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.DOWN)));
		addInfo("Canvas.FIRE: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.FIRE)));
		addInfo("Canvas.GAME_A: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.GAME_A)));
		addInfo("Canvas.GAME_B: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.GAME_B)));
		addInfo("Canvas.GAME_C: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.GAME_C)));
		addInfo("Canvas.GAME_D: ", canvas.getKeyName(canvas
				.getKeyCode(Canvas.GAME_D)));
	 ...
	 * 
	 * @see
	 * com.grimo.me.product.midpsysinfo.DynamicTestView#paint(javax.microedition
	 * .lcdui.Graphics)
	 */
	public void paint(Graphics g) {
		g.setColor(0xFFFFFF);
		...
		g.drawString("Or press 0 to skip.", 1, fontHeight, Graphics.TOP
				| Graphics.LEFT);
